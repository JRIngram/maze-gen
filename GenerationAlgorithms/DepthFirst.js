...
class DepthFirst{
    ...
    generateMaze(){
        ...
        let randomCell = this.maze.getRandomCell();
    ...
    generatePath(currentCell){
        ...
        let unvisitedNeighbours = this.maze.getUnvisitedNeigbourIndices(currentCell.y, currentCell.x);
        ...
        if(validDirections.length > 0){
            ...
            let nextDirection = validDirections[Math.floor(Math.random() * validDirections.length)];
